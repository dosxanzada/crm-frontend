<template>
  <Modal :isOpen="model" @onSubmit="submit" type="lg">
    ...
    <h3 slot="header" class="modal-title">Қызметкердің мәліметін өзгету</h3>
    ...
    <div slot="content" class="row">
      <div class="col-lg-6">
        ...
        <div :class="['form-group', {'has-error': errors.has('password')}]">
          ...
          <input id="field-password" class="form-control" name="password" type="password" v-model="model.password">
    ...
    <div slot="footer">
      ...
      <button type="submit" class="btn btn-success"><i class="fa fa-check"></i>&nbsp;&nbsp;Сақтау</button>
    </div>
